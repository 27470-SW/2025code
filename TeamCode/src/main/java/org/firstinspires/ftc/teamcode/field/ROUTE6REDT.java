...
public class ROUTE6REDT {
    ...
    public ROUTE6REDT(Route constructorRoute) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        route.addFunction(route::intakeOn);
        route.addLocation(route.intakepos2, LINE, HEAD_LINEAR);
        route.addLocation(route.intakeloading2, LINE, HEAD_LINEAR);
        ...
        route.addEvent(Route.Action.TANGENT, Math.toRadians(0));
        route.addFunction(route::intakeOn);
        route.addLocation(route.intakepos3, LINE, HEAD_LINEAR);
        route.addLocation(route.intakeloading3, LINE, HEAD_LINEAR);
